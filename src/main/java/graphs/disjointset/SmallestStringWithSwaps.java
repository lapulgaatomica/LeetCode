...
public class SmallestStringWithSwaps {
    public static void main(String[] args) {
        ...
        System.out.println(smallestStringWithSwaps("dcab", List.of(List.of(0, 3), List.of(1, 2), List.of(0, 2))));
        System.out.println(smallestStringWithSwaps("cba", List.of(List.of(0, 1), List.of(1, 2))));
    }
